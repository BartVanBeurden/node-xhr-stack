...
XhrService.prototype.request = function(method, url, options) {
...
XhrService.prototype.send = function(req, callback) {
	...
	sendStack.push(function(err) {
		...
		req._xhr.ontimeout = callback.bind(req, new Errors.TimeoutError("XHR Timeout", req, null));
		req._xhr.onerror = callback.bind(req, new Errors.NetworkError("XHR Network Error", req, null));
